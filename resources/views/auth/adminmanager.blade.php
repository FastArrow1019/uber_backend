				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-picture"></i>Admin Manager Dashboard
							</div>
						</div>
									...
									@foreach($users as $key => $user)
									    <tr>    
                						  ...
                						  <td>
											...
											@if($user->name == 'annakuz')
							  					<button type="button" class="label label-sm label-success" disabled style="border: 0px;">Update</button>
							  				@else
										  ...
										  <td>
							  				...
							  				@if($user->status == '2')
							  				<button type="button" class="label label-sm label-warning" disabled style="border: 0px;">Delete</button>
							  				@else
